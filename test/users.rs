...
impl Related<super::runtime_users_queues::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RuntimeUsersQueues.def()
    }
}
...
impl Related<super::users_queues_assignment::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::UsersQueuesAssignment.def()
    }
}
